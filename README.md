...
- **API Key Configuration (`config.js`)**: Easy interactive form to update your Google Maps, OpenAI, AISStream, NASA FIRMS, or TomTom API keys anytime.
...
3. Click **Install**.
4. Enter your API keys when prompted (or leave blank to configure later).
